...
/* ── Room data: DATABASE is the source of truth for which rooms exist ──
   $room_meta only enriches display (photos/descriptions/tags) when available.
   Any room added via the admin panel will show up automatically, even
   without a matching entry here — it'll just use the generic fallback look. */
$room_meta = [
    'Duplex Room'      => ['cap'=>2,'img'=>'../assets/images/standard_room.jpg',   'badge'=>'Overnight',        'desc'=>'Comfortable air-conditioned duplex room with free entrance and swimming included. Perfect for couples or small groups.','tags'=>['AC','WiFi','Free Swimming','Free Entrance']],
    'Family Room'      => ['cap'=>7,'img'=>'../assets/images/family_room.jpg',     'badge'=>'Best for Families','desc'=>'Spacious family room for larger groups with free entrance and swimming for all overnight guests.','tags'=>['AC','WiFi','Free Swimming','Free Entrance','Large Space']],
    'Small Bahay Kubo' => ['cap'=>4,'img'=>'../assets/images/small_bahay_kubo.jpg','badge'=>'Overnight',        'desc'=>'Cozy traditional Bahay Kubo-style accommodation with a relaxed and natural atmosphere.','tags'=>['Free Swimming','Free Entrance','Nature View']],
    'Large Bahay Kubo' => ['cap'=>6,'img'=>'../assets/images/large_bahay_kubo.jpg','badge'=>'Popular',          'desc'=>'Spacious traditional Bahay Kubo perfect for groups, with beautiful resort grounds and amenities.','tags'=>['Free Swimming','Free Entrance','Nature View','Large Space']],
];
$default_meta = [
    'cap'   => 4,
    'img'   => '../assets/images/standard_room.jpg',
    'badge' => 'Available',
    'desc'  => 'A comfortable accommodation at CoraVergel Resort. Contact us for more details about this room.',
    'tags'  => ['Free Entrance'],
];

$db_rooms = getAllRooms($conn); // room_name => [room_id, price, total_units]
$rooms = [];
foreach ($db_rooms as $name => $db_row) {
    $meta = $room_meta[$name] ?? $default_meta;
    $rooms[] = array_merge($meta, [
        'id'    => $name,
...
/* Room price/image lookup — now generated from the DB-driven $rooms array
   instead of a separate hardcoded list, so it never goes out of sync. */
