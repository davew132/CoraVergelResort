...
<nav class="navbar">
    ...
    <div class="nav-login">
        <a href="../user/login.php" class="profile-btn">
...
<footer class="site-footer">
    ...
    <div class="footer-links">
        ...
        <div class="footer-col footer-contact-col">
            <h4>Contact</h4>
            <a href="tel:+6396 9033 2995">+6396 9033 2995</a>
            ...
            <div class="footer-map-icons">
                <a class="fa-solid fa-location-dot"
                   href="https://www.google.com/maps/@10.714106,122.396162,16z"
                   target="_blank" rel="noopener noreferrer"
                   title="View on Google Maps"></a>
            </div>
        </div>
    </div>
    <div class="footer-bottom">
        <span>&copy; <?php echo date('Y'); ?> CoraVergel Resort. All rights reserved.</span>
