...
<section class="included-section">
    ...
    <div class="included-grid">
        <div class="included-card">
            <i class="fa-solid fa-wifi included-icon"></i>
            <h3>Free WiFi</h3>
            <p>High-speed internet throughout the resort</p>
        </div>
        <div class="included-card">
            <i class="fa-solid fa-mug-saucer included-icon"></i>
            <h3>Breakfast Included</h3>
            <p>Complimentary breakfast buffet daily</p>
        </div>
        <div class="included-card">
            <i class="fa-solid fa-wind included-icon"></i>
...
<div class="footer-right">
    <div class="footer-socials">
        <a href="https://www.facebook.com/coravergelresort" 
           class="facebook"
           aria-label="Facebook" 
           target="_blank">
        ...
        <a href="https://instagram.com/coravergelresort"
           class="instagram"
        ...
        <a href="https://tiktok.com/@coravergelresort"
           class="tiktok"
           aria-label="TikTok"
           target="_blank">
    ...
    <div class="footer-links">
        ...
        <div class="footer-col footer-contact-col">
            ...
            <a href="tel:+633202512" class="topbar-link footer-contact-col">+320 2512</a>
