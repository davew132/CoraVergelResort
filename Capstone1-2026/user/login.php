...
<nav class="navbar">
    <div class="nav-links">
        <a href="../frontend/about.php">Experience</a>
        <a href="../frontend/rooms.php">Rooms &amp; Rates</a>
        <a href="../frontend/guest.php#gallery">Gallery</a>
        <a href="../frontend/special_offers.php">Deals</a>
        <a href="../frontend/guest.php#contact">Contact</a>
    </div>
