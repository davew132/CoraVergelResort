...
<nav class="navbar">
    <div class="nav-links">
        ...
        <a href="../user/dashboard.php#booking-section">Booking</a>
        <a href="special_offers.php">Special Offers</a>
        <a href="reviews.php">Reviews</a>
        <a href="../user/dashboard.php#contact">Contact</a>
    </div>
...
<footer class="site-footer">
    ...
    <div class="footer-links">
        ...
        <div class="footer-col">
            ...
            <a href="https://www.google.com/maps/@10.714106,122.396162,16z" target="_blank" rel="noopener noreferrer">21 Barosong, Tigbauan,<br>Iloilo City, Philippines</a>
        </div>
    </div>
    <div class="footer-bottom">
        <span>&copy; <?= date('Y') ?> CoraVergel Resort. All rights reserved.</span>
