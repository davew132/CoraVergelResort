...
<div class="modal-overlay" id="loginModal">
    <div class="modal-box">
        <div class="modal-room-header">
            ...
            <img class="modal-room-img" id="modalRoomImg"
                 src="../assets/images/1.jpg" alt="Room">
            <div class="modal-room-name" id="modalRoomName">Duplex Room</div>
            <div class="modal-room-price" id="modalRoomPrice">₱3,200 / night</div>
        </div>
        ...
        <div class="modal-body">
            <div class="modal-login-message">
                ...
                <div class="modal-login-title">Login to Book This Room</div>
                <div class="modal-login-sub">
                    Create a free account or log in to complete your reservation at CoraVergel Resort.
                </div>
            </div>
            ...
            <div class="modal-benefits">
                ...
                <div class="modal-benefit-row">
                    ...
                    View and manage your bookings anytime
                </div>
                <div class="modal-benefit-row">
            ...
            <a id="modalLoginBtn" href="../user/login.php" class="modal-btn-login">
                <i class="fa-regular fa-user"></i> Login to Book
            </a>
            <a href="../user/login.php?tab=register" class="modal-btn-register">
...
<footer class="site-footer">
    <div class="footer-top">
        <div class="footer-brand">
            <div class="footer-logo-wrap">
                <img src="../assets/images/logo/cv_logo.png" alt="CoraVergel Resort" class="footer-logo-img">
            </div>
        </div>
    ...
    <div class="footer-links">
        ...
        <div class="footer-col">
            <h4>Contact</h4>
            <a href="tel:+639690332995">+63 969 033 2995</a>
            <a href="mailto:coravergelresort@gmail.com">coravergelresort@gmail.com</a>
            <a href="https://www.google.com/maps/@10.714106,122.396162,16z" target="_blank" rel="noopener noreferrer">
                21 Barosong, Tigbauan,<br>Iloilo City, Philippines
            </a>
        </div>
    </div>
    <div class="footer-bottom">
        <span>&copy; <script>document.write(new Date().getFullYear())</script> CoraVergel Resort. All rights reserved.</span>
...
function openModal(roomName, roomPrice, roomImg) {
    ...
    document.getElementById('modalRoomImg').src           = roomImg;

    /* Pass room name as query param so login page can redirect back properly */
    const redirect = encodeURIComponent('rooms.php');
    document.getElementById('modalLoginBtn').href =
        '../user/login.php?redirect=' + redirect + '&room=' + encodeURIComponent(roomName);
